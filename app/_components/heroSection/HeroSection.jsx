...
function HeroSection() {
  return (
    <>
      <div className="  relative p-8 flex justify-center mt-[5rem] ">
        ...
        <div className=" flex flex-col gap-6">
          <h1 className=" text-[2.4rem] md:text-6xl lg:text-[4rem] text-center font-semibold">
            Learn and Grow with <br />
            Top <span className=" text-primary">Online Courses</span>
          </h1>
